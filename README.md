...
├── images-Readme
│   ├── correlation.png
│   ├── features-distributions.png
│   ├── locahost-docs-1.png
│   ├── localhost-docs-click-try-out.png
│   ├── localhost-docs-drop-down-box.png
│   ├── server-response.png
...
```
4. The score prediction appears in console.
```bash
student-performance-prediction
❯ curl -X 'POST' \
  'http://127.0.0.1:8000/predict' \
...
3. Open another terminal and move into the project folder.
